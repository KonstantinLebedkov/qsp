...
INLINE char qspGetStatCode(QSPString s, QSP_CHAR **pos)
{
...
void qspInitLineOfCode(QSPLineOfCode *line, QSPString str, int lineNum)
{
    ...
    //line->Str = str; //included in constructor
    //line->LineNum = lineNum; //included in constructor
    //line->StatsCount = 0; //included in constructor
    //line->Stats = 0; //included in constructor
    qspDelFirstSpc(&str);
