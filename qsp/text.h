...
#include "coding.h"
    ...
    {// равноценно применению substr с указанием начала и длины извлекаемого, только здесь начало и конец. причем конец как-бы в строку не входит, но тут может не €вл€тьс€ пробелом, пустым, символом конца строки и тд
        QSPString string;
        string.Str = start;
        string.End = end;
        return string;
