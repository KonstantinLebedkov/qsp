...
//TODO: разобратьс€, нужен ли вообще дефайн типа  ”—ѕ_Ё —“≈–Ќ. подозреваю, что нет, совсем нет!
#ifdef EXPORT
#ifdef _WIN
...
//TODO: разобратьс€, а набу€ нужны все эти энумы в кусп-хедере?
enum
{
...
typedef std::wstring QSPString;

    //TODO: можно ли вообще отказатьс€ от этого  ”—ѕстринга и вз€ть ќЅџ„Ќџ… плюсовый стринг? вообще-то, это ќЅя«ј“≈Ћ№Ќќ Ќ”∆Ќќ сделать
...
//TODO: вы€снить, надо ли этот инт? есть же нормальный инт, обыкновенный.
typedef bool QSP_BOOL;

#define QSP_TRUE true
#define QSP_FALSE false
